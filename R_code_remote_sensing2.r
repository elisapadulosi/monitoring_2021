...
cl <- colorRampPalette(c('black','grey','light grey'))(100) # change colors
plot(p224r63_2011, col=cl)

# to see 4 bands
par(mfrow=c(2,2))
clb <- colorRampPalette(c('dark blue','blue','light blue'))(100) # 
plot(p224r63_2011$B1_sre, col=clb)# $ to link in R

# to change the color of the second band
clg <- colorRampPalette(c('dark green','green','light green'))(100) 
plot(p224r63_2011$B2_sre, col=clg)

# to change the color of the third band
